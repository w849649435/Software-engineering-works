...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="layout_left_menu">
            <ul id="menu">
                <li class="childUlLi">
                    <a href="#"  target="menuFrame"><i class="glyph-icon icon-home"></i>会员管理</a>
                    <ul>
                                <li><a href="${pageContext.request.contextPath}/admin/contacts/list.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示会员信息</a>
                        </li>
                        
                        <li><a href="${pageContext.request.contextPath}/admin/EasyUICRUD/list.jsp" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>JqueryUI</a>
                        </li>
                    </ul>
                </li>
                 ...
                 <li class="childUlLi">
                    <a href="#"  target="menuFrame"><i class="glyph-icon icon-home"></i>会员管理</a>
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/admin/member/list.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示全部会员记录</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="childUlLi">
                    ...
                    <ul>
                                 ...
                                 <li><a href="${pageContext.request.contextPath}/admin/user/listUserAndContacts.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示全部信息</a></li>
                ...
                <li class="childUlLi">
                    ...
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/admin/loginfo/listByPage.action" target="menuFrame">
                 ...
                 <li class="childUlLi">
                    ...
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/admin/user/updatePassword.jsp" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>修改密码</a></li>
                                
                        <li><a href="${pageContext.request.contextPath}/logout.action"><i class="glyph-icon icon-chevron-right"></i>退出登录</a></li>
                    </ul>
                </li>
