    ...
    <body>
        ...
        <div class="layout_left_menu">
            <ul id="menu">
                 ...
                 <li class="childUlLi">
                    <a href="#"  target="menuFrame"><i class="glyph-icon icon-home"></i>教师管理</a>
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/user/jiaoshi/listByPage.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示教师记录</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="childUlLi">
                    ...
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/user/user/updatePassword.jsp" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>修改密码</a></li>
                                 <li><a href="${pageContext.request.contextPath}/user/user/toUpdateUser.action" target="menuFrame">
