...
<html>
    ...
    $(document).ready(function(){
        ...
        $.ajax({type: "post", url: "${pageContext.request.contextPath}/user/user/updatePassword.action", data:{"password":password,"oldPassword":oldPassword}, success: function (data) {
       		 alert(data);  
