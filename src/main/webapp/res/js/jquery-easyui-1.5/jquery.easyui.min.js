...
_232.isLoaded=false;
if(opts.loadingMember){
$(_230).panel("clear");
$(_230).html($("<div class=\"panel-loading\"></div>").html(opts.loadingMember));
}
...
return $.extend({},$.parser.parseOptions(_26d,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMember:(t.attr("loadingMember")!=undefined?t.attr("loadingMember"):undefined),header:(hh.length?hh.removeClass("panel-header"):undefined),footer:(ff.length?ff.removeClass("panel-footer"):undefined)});
};
...
opts.err(_4af,_4b0.member,"hide");
};
function _4b1(e){
var _4b2=e.data.target;
var _4b3=$.data(_4b2,"validatebox");
_4b3.options.err(_4b2,_4b3.member,"show");
};
function _4b4(e){
var _4b5=e.data.target;
var _4b6=$.data(_4b5,"validatebox");
if(!_4b6.validating){
_4b6.options.err(_4b5,_4b6.member,"hide");
}
};
...
var _4c8=rule["member"];
if(_4c7){
for(var i=0;i<_4c7.length;i++){
_4c8=_4c8.replace(new RegExp("\\{"+i+"\\}","g"),_4c7[i]);
}
}
_4c1(opts.invalidMember||_4c8);
return false;
}
}
return true;
...
var t=$(_4d3);
return $.extend({},$.parser.parseOptions(_4d3,["validType","missingMember","invalidMember","tipPosition",{delay:"number",interval:"number",deltaX:"number"},{editable:"boolean",validateOnCreate:"boolean",validateOnBlur:"boolean"}]),{required:(t.attr("required")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),novalidate:(t.attr("novalidate")!=undefined?true:undefined)});
};
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMember:"该字段必填.",invalidMember:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4aa,blur:_4ae,mouseenter:_4b1,mouseleave:_4b4,click:function(e){
var t=$(e.data.target);
...
},member:"Please enter a valid email address."},url:{validator:function(_4d9){
...
},member:"Please enter a valid URL."},length:{validator:function(_4da,_4db){
var len=$.trim(_4da).length;
return len>=_4db[0]&&len<=_4db[1];
},member:"Please enter a value between {0} and {1}."},remote:{validator:function(_4dc,_4dd){
var data={};
data[_4dd[1]]=_4dc;
