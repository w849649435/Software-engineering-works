...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Това поле е задължително.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Моля, въведете валиден имейл адрес.';
	$.fn.validatebox.defaults.rules.url.member = 'Моля въведете валиден URL.';
	$.fn.validatebox.defaults.rules.length.member = 'Моля, въведете стойност между {0} и {1}.';
}
if ($.fn.calendar){
