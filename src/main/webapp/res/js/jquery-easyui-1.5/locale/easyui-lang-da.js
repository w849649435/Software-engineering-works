...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Dette felt er påkrævet.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Angiv en gyldig e-mail-adresse.';
	$.fn.validatebox.defaults.rules.url.member = 'Angiv en gyldig webadresse.';
	$.fn.validatebox.defaults.rules.length.member = 'Angiv en værdi mellem {0} og {1}.';
}
if ($.fn.calendar){
