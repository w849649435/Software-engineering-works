...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Die veld is verpligtend.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = "Gee 'n geldige e-pos adres.";
	$.fn.validatebox.defaults.rules.url.member = "Gee 'n geldige URL nie.";
	$.fn.validatebox.defaults.rules.length.member = "Voer 'n waarde tussen {0} en {1}.";
}
if ($.fn.calendar){
