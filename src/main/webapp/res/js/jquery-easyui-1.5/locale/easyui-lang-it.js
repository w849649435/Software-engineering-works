...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Questo campo è richiesto.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Inserisci un indirizzo email valido.';
	$.fn.validatebox.defaults.rules.url.member = 'Inserisci un URL valido.';
	$.fn.validatebox.defaults.rules.length.member = 'Inserisci un valore tra {0} e {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Correggere questo campo.';
}
if ($.fn.calendar){
