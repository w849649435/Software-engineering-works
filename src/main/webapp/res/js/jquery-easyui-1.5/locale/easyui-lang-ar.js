...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'هذا الحقل مطلوب.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'الرجاء إدخال بريد إلكتروني صحيح.';
	$.fn.validatebox.defaults.rules.url.member = 'الرجاء إدخال رابط صحيح.';
	$.fn.validatebox.defaults.rules.length.member = 'الرجاء إدخال قيمة بين {0} و {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'الرجاء التأكد من الحقل.';
}
if ($.fn.calendar){
