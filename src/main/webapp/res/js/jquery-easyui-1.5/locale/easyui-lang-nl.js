...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Dit veld is verplicht.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Geef een geldig e-mailadres.';
	$.fn.validatebox.defaults.rules.url.member = 'Vul een geldige URL.';
	$.fn.validatebox.defaults.rules.length.member = 'Voer een waarde tussen {0} en {1}.';
}
if ($.fn.calendar){
