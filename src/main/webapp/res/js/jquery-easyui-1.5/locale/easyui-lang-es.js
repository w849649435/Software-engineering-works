...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Este campo es obligatorio.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Por favor ingrese una direcci&oacute;n de correo v&aacute;lida.';
	$.fn.validatebox.defaults.rules.url.member = 'Por favor ingrese una URL v&aacute;lida.';
	$.fn.validatebox.defaults.rules.length.member = 'Por favor ingrese un valor entre {0} y {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Por favor corrija este campo.';
}
if ($.fn.calendar){
