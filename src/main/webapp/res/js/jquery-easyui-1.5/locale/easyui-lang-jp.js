...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = '入力は必須です。';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = '正しいメールアドレスを入力してください。';
	$.fn.validatebox.defaults.rules.url.member = '正しいURLを入力してください。';
	$.fn.validatebox.defaults.rules.length.member = '{0} から {1} の範囲の正しい値を入力してください。';
	$.fn.validatebox.defaults.rules.remote.member = 'このフィールドを修正してください。';
}
if ($.fn.calendar){
