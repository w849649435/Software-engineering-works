...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
    ...
    if ($.fn[plugin]){
        $.fn[plugin].defaults.missingMember = 'Detta fält är obligatoriskt.';
    }
});
if ($.fn.validatebox) {
    $.fn.validatebox.defaults.rules.email.member = 'Vänligen ange en korrekt e-post adress.';
    $.fn.validatebox.defaults.rules.url.member = 'Vänligen ange en korrekt URL.';
    $.fn.validatebox.defaults.rules.length.member = 'Vänligen ange ett nummer mellan {0} och {1}.';
    $.fn.validatebox.defaults.rules.remote.member = 'Vänligen åtgärda detta fält.';
}
if ($.fn.calendar) {
