...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Esse campo é requerido.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Insira um endereço de email válido.';
	$.fn.validatebox.defaults.rules.url.member = 'Insira uma URL válida.';
	$.fn.validatebox.defaults.rules.length.member = 'Insira uma valor entre {0} e {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Corrija esse campo.';
}
if ($.fn.calendar){
