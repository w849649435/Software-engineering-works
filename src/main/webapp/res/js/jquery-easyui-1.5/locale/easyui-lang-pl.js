...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'To pole jest wymagane.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Wprowadź poprawny adres email.';
	$.fn.validatebox.defaults.rules.url.member = 'Wprowadź poprawny adres URL.';
	$.fn.validatebox.defaults.rules.length.member = 'Wprowadź wartość z zakresu od {0} do {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Proszę poprawić to pole.';
}
if ($.fn.calendar){
