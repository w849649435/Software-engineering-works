...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Το πεδίο είναι υποχρεωτικό.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Παρακαλώ εισάγετε σωστή Ηλ.Διεύθυνση.';
	$.fn.validatebox.defaults.rules.url.member = 'Παρακαλώ εισάγετε σωστό σύνδεσμο.';
	$.fn.validatebox.defaults.rules.length.member = 'Παρακαλώ εισάγετε τιμή μεταξύ {0} και {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Παρακαλώ διορθώστε αυτό το πεδίο.';
}
if ($.fn.calendar){
