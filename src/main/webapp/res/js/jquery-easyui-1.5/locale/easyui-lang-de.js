...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Dieses Feld wird benötigt.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Bitte geben Sie eine gültige E-Mail-Adresse ein.';
	$.fn.validatebox.defaults.rules.url.member = 'Bitte geben Sie eine gültige URL ein.';
	$.fn.validatebox.defaults.rules.length.member = 'Bitte geben Sie einen Wert zwischen {0} und {1} ein.';
}
if ($.fn.calendar){
