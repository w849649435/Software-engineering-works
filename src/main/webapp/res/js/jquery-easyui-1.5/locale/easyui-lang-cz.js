...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Toto pole je vyžadováno.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Zadejte, prosím, platnou e-mailovou adresu.';
	$.fn.validatebox.defaults.rules.url.member = 'Zadejte, prosím, platnou adresu URL.';
	$.fn.validatebox.defaults.rules.length.member = 'Zadejte, prosím, hodnotu mezi {0} a {1}.';
}
if ($.fn.calendar){
