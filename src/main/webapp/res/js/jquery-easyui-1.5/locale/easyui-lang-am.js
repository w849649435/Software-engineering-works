...
$.map(['validatebox','textbox','passwordbox','filebox','searchbox',
	...
	if ($.fn[plugin]){
		$.fn[plugin].defaults.missingMember = 'Այս դաշտը պարտադիր է.';
	}
});
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.member = 'Խնդրում ենք մուտքագրել գործող e-mail հասցե.';
	$.fn.validatebox.defaults.rules.url.member = 'Խնդրում ենք մուտքագրել գործող URL.';
	$.fn.validatebox.defaults.rules.length.member = 'Խնդրում ենք մուտքագրել արժեք {0}  {1}.';
	$.fn.validatebox.defaults.rules.remote.member = 'Խնդրում ենք ուղղել այս դաշտը.';
}
if ($.fn.calendar){
